...
test.describe('Playground', () => {
  ...
  test('langflow keeps automatic login opt-in', async ({ page }) => {
    ...
    await expect(page.locator('input[data-field-key="image.tag"]')).toHaveValue('1.12.1');
    const code = page.locator('#playground-code');
  ...
  test('netbird defaults stay aligned with the chart', async ({ page }) => {
    ...
    await expect(page.locator('input[data-field-key="server.image.tag"]')).toHaveValue('0.78.1');
  ...
  test('poznote defaults stay aligned with the chart', async ({ page }) => {
    ...
    await expect(page.locator('input[data-field-key="image.tag"]')).toHaveValue('6.80.0');
  ...
  test('redis defaults stay aligned with the chart', async ({ page }) => {
    await page.goto('/playground');
    await page.locator('.playground-chart-btn[data-slug="redis"]').click();

    await expect(page.locator('input[data-field-key="image.tag"]')).toHaveValue('8.10.1');
