      ...
      fields: [
        {
          ...
          key: 'image.tag',
          type: 'text',
          default: 'v2.39.0@sha256:aaa79085ff93049e074a5725a1f7689298ac0a07aedac07830e2bb45665d6caf',
          description: 'Official image pinned by immutable digest',
        },
        {
          label: 'Public origin',
        ...
        },
        {
          ...
          description: 'Initial native administrator; public invites stay closed',
        },
        {
          label: 'Workspace name',
          key: 'bootstrap.workspaceName',
          type: 'text',
          default: 'HelmForge CRM',
          description: 'Initial workspace display name',
        },
        {
          label: 'Initial password Secret',
          key: 'bootstrap.existingSecret',
          type: 'text',
          default: '',
          description: 'Existing Secret with user-password',
        },
        {
          label: 'Retained identity Secret',
          key: 'identity.existingSecret',
          type: 'text',
          default: '',
          description: 'Preserve ENCRYPTION_KEY and SERVER_ID',
        },
        {
          ...
          type: 'text',
          default: '10Gi',
          description: 'Native local files and required identity marker',
        },
      ],
    },
    {
      ...
      fields: [
        {
          label: 'PostgreSQL credential Secret',
          key: 'postgresql.auth.existingSecret',
          type: 'text',
          default: '',
          description: 'Native database role credentials',
        },
        {
          label: 'Redis credential Secret',
          key: 'redis.auth.existingSecret',
          type: 'text',
          default: '',
          description: 'Authenticated Redis with noeviction queue storage',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'true',
          description: 'Disable for an existing PostgreSQL service',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Certificate-matching external hostname',
        },
        {
          label: 'Database name',
          key: 'database.name',
          type: 'text',
          default: 'twenty',
          description: 'Dedicated database with schema creation privileges',
        },
        {
          ...
          type: 'text',
          default: 'twenty',
          description: 'Native application role',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Existing Secret with password',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Additional certificate authority; verify-full stays enabled',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'true',
          description: 'Disable for an existing durable Redis service',
        },
        {
        ...
        },
        {
          ...
          type: 'number',
          default: '6379',
          description: 'External TLS listener',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Optional ACL identity',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Existing Secret with redis-password',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Additional CA; authenticated TLS stays enabled',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'select',
          default: 'local',
          description: 'S3 does not remove the identity PVC or provide backups',
          options: ['local', 's3'],
        },
        {
          label: 'S3 bucket',
          ...
          type: 'text',
          default: '',
          description: 'Existing private application bucket',
        },
        {
          label: 'S3 region',
          ...
          type: 'text',
          default: 'us-east-1',
          description: 'Native signing region',
        },
        {
          label: 'S3 endpoint',
        ...
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Access key ID and secret access key',
        },
        {
          label: 'S3 CA Secret',
          key: 'storage.s3.caSecret',
          type: 'text',
          default: '',
          description: 'Optional additional certificate authority',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'false',
          description: 'Authenticated implicit TLS on native port 465',
        },
        {
          label: 'SMTP hostname',
          key: 'smtp.host',
          type: 'text',
          default: '',
          description: 'Certificate-matching mail service',
        },
        {
          label: 'Sender email',
          key: 'smtp.from',
          type: 'text',
          default: '',
          description: 'Verified bare email address',
        },
        {
          label: 'SMTP username',
          key: 'smtp.username',
          type: 'text',
          default: '',
          description: 'Native transport authentication identity',
        },
        {
          label: 'SMTP password Secret',
          key: 'smtp.existingSecret',
          type: 'text',
          default: '',
          description: 'Existing Secret with password',
        },
        {
          label: 'SMTP CA Secret',
          key: 'smtp.tls.caSecret',
          type: 'text',
          default: '',
          description: 'Optional additional certificate authority',
        },
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'false',
          description: 'Private server exporter; worker health remains separate',
        },
        {
          label: 'ServiceMonitor',
          key: 'metrics.serviceMonitor.enabled',
          type: 'toggle',
          default: 'false',
          description: 'Requires metrics and Prometheus Operator CRDs',
        },
        {
      ...
      fields: [
        {
          ...
          key: 'image.tag',
          type: 'text',
          default: 'v5.3.0@sha256:c487ec5edcfe054bcb312fcd498f868e56f274756d0046b01c83f210855017ab',
          description: 'Official image pinned by immutable digest',
        },
        {
          label: 'Public origin',
        ...
        },
        {
          ...
          type: 'text',
          default: 'owner@example.test',
          description: 'Native ordinary user; public signup stays closed',
        },
        {
          label: 'Initial password Secret',
          key: 'bootstrap.existingSecret',
        ...
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Preserve AUTH_SECRET and ENCRYPTION_SECRET',
        },
        {
          label: 'Persistent capacity',
          key: 'persistence.size',
          type: 'text',
          default: '10Gi',
          description: 'Local uploads and required identity marker',
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'External DNS hostname matching the certificate',
        },
        {
          label: 'Database password Secret',
          key: 'database.passwordSecret',
          type: 'text',
          default: '',
          description: 'External role credentials; default key password',
        },
        {
          label: 'Database CA Secret',
          key: 'database.tls.caSecret',
          type: 'text',
          default: '',
          description: 'Optional CA bundle for verify-full TLS',
        },
        {
          label: 'Database name',
          key: 'database.name',
          type: 'text',
          default: 'reactive_resume',
          description: 'Dedicated external database',
        },
        {
          label: 'Database username',
          key: 'database.username',
          type: 'text',
          default: 'reactive_resume',
          description: 'Native database role',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'false',
          description: 'Enable actual email delivery through authenticated implicit TLS',
        },
        {
          label: 'SMTP hostname',
          key: 'smtp.host',
          type: 'text',
          default: '',
          description: 'Certificate-matching SMTP hostname',
        },
        { label: 'SMTP sender', key: 'smtp.from', type: 'text', default: '', description: 'Verified sender address' },
        { label: 'SMTP username', key: 'smtp.username', type: 'text', default: '', description: 'SMTP account name' },
        {
          label: 'SMTP password Secret',
          key: 'smtp.existingSecret',
          type: 'text',
        ...
        { label: 'SMTP port', key: 'smtp.port', type: 'number', default: '465', description: 'Implicit TLS listener' },
        {
          label: 'SMTP CA Secret',
          key: 'smtp.tls.caSecret',
          type: 'text',
          default: '',
          description: 'Additional private certificate authority',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'select',
          default: 'local',
          description: 'A private bucket still serves native public picture URLs',
          options: ['local', 's3'],
        },
        {
          label: 'S3 bucket',
          ...
          type: 'text',
          default: '',
          description: 'Existing dedicated bucket',
        },
        {
          label: 'S3 endpoint',
          key: 'storage.s3.endpoint',
          type: 'text',
          default: '',
          description: 'Optional HTTPS compatible endpoint',
        },
        {
          label: 'S3 credentials Secret',
          key: 'storage.s3.existingSecret',
          type: 'text',
          default: '',
          description: 'Existing access-key-id and secret-access-key entries',
        },
        {
          label: 'S3 region',
          key: 'storage.s3.region',
        ...
        },
        {
          ...
          type: 'toggle',
          default: 'false',
          description: 'Enable for compatible endpoints that require path-style buckets',
        },
        {
          label: 'S3 CA Secret',
          key: 'storage.s3.caSecret',
          type: 'text',
          default: '',
          description: 'Additional certificate authority for the native client',
        },
      ],
    },
    {
      name: 'Linked-user OAuth2',
      fields: [
        {
          label: 'Enable OAuth2',
          key: 'oauth.enabled',
          type: 'toggle',
          default: 'false',
          description: 'Verify the local email through SMTP before linking; public signup stays closed',
        },
        {
          label: 'Provider name',
          key: 'oauth.name',
          ...
          description: 'Display name on the login page',
        },
        {
          label: 'Client ID',
          key: 'oauth.clientId',
          type: 'text',
          default: '',
          description: 'Registered confidential client',
        },
        {
          label: 'Client Secret',
          key: 'oauth.existingSecret',
          type: 'text',
          default: '',
          description: 'Existing Secret with client-secret',
        },
        {
          label: 'Authorization URL',
          key: 'oauth.authorizationUrl',
          type: 'text',
          default: '',
          description: 'HTTPS browser authorization endpoint',
        },
        {
          label: 'Token URL',
          key: 'oauth.tokenUrl',
          type: 'text',
          default: '',
          description: 'HTTPS server token endpoint',
        },
        {
          label: 'Userinfo URL',
          key: 'oauth.userInfoUrl',
          type: 'text',
          default: '',
          description: 'HTTPS userinfo with stable id and email; sub alone is insufficient',
        },
        {
          label: 'OAuth CA Secret',
          key: 'oauth.caSecret',
          type: 'text',
          default: '',
          description: 'Additional certificate authority',
        },
      ],
    },
  ],
      ...
      fields: [
        {
          ...
          type: 'text',
          default: 'v10.5.0',
          description: 'Pinned official image; local accounts only, OIDC and S3 unsupported',
        },
        {
          label: 'Public URL',
          key: 'server.publicUrl',
          ...
          description: 'Exact HTTPS origin for remote use',
        },
        {
          label: 'Administrator username',
          key: 'bootstrap.username',
          type: 'text',
          default: 'admin',
          description: 'Initial local administrator; existing users are preserved',
        },
        {
          label: 'Initial password Secret',
          key: 'bootstrap.existingSecret',
          type: 'text',
          default: '',
          description: 'Changing this Secret does not reset an existing account',
        },
        {
          label: 'Administrator token Secret',
          key: 'auth.existingSecret',
          type: 'text',
          default: '',
          description: 'Retain the strong administrative override across recovery',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'true',
          description: 'HelmForge database with native extensions and restricted application credentials',
        },
        {
          ...
          type: 'text',
          default: '8Gi',
          description: 'Durable tracking records and native sessions',
        },
        {
          label: 'External host',
          key: 'database.host',
          type: 'text',
          default: '',
          description: 'Disable bundled PostgreSQL before supplying external components',
        },
        {
          ...
          type: 'text',
          default: 'ryot',
          description: 'DBA must prepare uuid-ossp and pg_trgm',
        },
        {
          ...
          type: 'text',
          default: 'ryot',
          description: 'Non-superuser application role',
        },
        {
          label: 'External password Secret',
          key: 'database.passwordSecret',
          type: 'text',
          default: '',
          description: 'External TLS is verified by default',
        },
        {
          label: 'Database CA Secret',
          key: 'database.caSecret',
          type: 'text',
          default: '',
          description: 'Private CA for the external PostgreSQL server',
        },
      ],
    },
  ],
      ...
      fields: [
        {
          ...
          key: 'image.tag',
          type: 'text',
          default: '26.6.2-rootless',
          description: 'Pinned official rootless image',
        },
        {
          label: 'Public URL',
          key: 'server.publicUrl',
          ...
          description: 'Exact HTTPS origin for remote authentication',
        },
        {
          label: 'Administrator email',
          key: 'bootstrap.email',
          type: 'text',
          default: 'admin@example.test',
          description: 'Initial administrator; existing accounts remain intact',
        },
        {
          label: 'Administrator Secret',
          key: 'bootstrap.existingSecret',
          type: 'text',
          default: '',
          description: 'Initial password from an existing Secret',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Retain the signing key across upgrades and recovery',
        },
        {
          ...
          type: 'text',
          default: '5Gi',
          description: 'Local database and document originals',
        },
        {
          label: 'Allow signup',
          ...
          type: 'toggle',
          default: 'false',
          description: 'Password signup creates ordinary users; custom OAuth admission is separate',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'select',
          default: 'filesystem',
          description: 'Changing drivers requires explicit migration',
        ...
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'HTTPS endpoint of an existing bucket',
        },
        {
          label: 'S3 bucket',
          key: 'storage.s3.bucket',
          type: 'text',
          default: '',
          description: 'Existing document bucket',
        },
        {
          label: 'S3 credentials Secret',
          key: 'storage.s3.existingSecret',
          type: 'text',
          default: '',
          description: 'Static access key and secret key',
        },
        {
          label: 'Document encryption Secret',
          key: 'storage.encryptionSecret',
          type: 'text',
          default: '',
          description: 'Retain every key version referenced by originals',
        },
        {
          label: 'Local database encryption Secret',
          key: 'database.encryptionSecret',
          type: 'text',
          default: '',
          description: 'For a newly created local database; preserve the exact key',
        },
        {
          label: 'Remote libSQL URL',
          key: 'database.remoteUrl',
          type: 'text',
          default: '',
          description: 'Optional authenticated HTTPS libSQL; local encryption is incompatible',
        },
        {
          label: 'libSQL token Secret',
          key: 'database.authTokenSecret',
          type: 'text',
          default: '',
          description: 'Required with a remote libSQL URL',
        },
      ],
    },
  ],
      ...
      fields: [
        {
          ...
          description: 'Switch the bundled engine, or keep all subcharts disabled for an external server',
        },
        {
          label: 'Bundled postgresql',
          key: 'postgresql.enabled',
          type: 'toggle',
          default: 'true',
          description: 'Select PostgreSQL and deploy its HelmForge subchart; disables the other databases',
        },
        {
          label: 'Bundled mysql',
          key: 'mysql.enabled',
          type: 'toggle',
          default: 'false',
          description: 'Select MySQL and deploy its HelmForge subchart; disables the other databases',
        },
        {
          label: 'Bundled mariadb',
          key: 'mariadb.enabled',
          type: 'toggle',
          default: 'false',
          description: 'Select MariaDB and deploy its HelmForge subchart; disables the other databases',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Required when all database subcharts are disabled',
        },
        {
          label: 'External port',
          key: 'database.port',
          type: 'number',
          default: '0',
          description: 'Zero selects 5432 for PostgreSQL or 3306 for MySQL/MariaDB',
        },
        {
          label: 'External credentials Secret',
          key: 'database.existingSecret',
          type: 'text',
          default: '',
          description: 'Existing Secret containing the external database password',
        },
        {
          label: 'MySQL/MariaDB TLS',
          key: 'database.mysqlSslMode',
          type: 'select',
          default: 'disable',
          options: ['disable', 'require', 'verify-full'],
          description: 'Use verify-full and a CA Secret for verified external connections',
        },
        {
          ...
          description: 'For PostgreSQL, use verify-full and a CA Secret to verify server identity',
        },
        {
          label: 'Database CA Secret',
          key: 'database.tlsSecret',
          type: 'text',
          default: '',
          description: 'CA certificate Secret required for verified database TLS',
        },
      ],
    },
    {
  ...
  vaultwarden: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          label: 'Private CA Secret',
          key: 'backup.s3.caSecret',
          type: 'text',
          default: '',
          conflictsWith: ['backup.s3.insecureSkipVerify'],
          description: 'Secret containing the CA certificate trusted for the S3 endpoint',
        },
        {
          label: 'Private CA Secret Key',
          key: 'backup.s3.caKey',
          type: 'text',
          default: 'ca.crt',
          description: 'Key containing the CA certificate',
        },
        {
          label: 'Skip TLS Verification',
          key: 'backup.s3.insecureSkipVerify',
          type: 'toggle',
          default: 'false',
          conflictsWith: ['backup.s3.caSecret'],
          description: 'Dangerous fallback; prefer a private CA Secret',
        },
      ],
    },
  ],
      ...
      fields: [
        {
          ...
          type: 'text',
          default: '0.30.0',
          description: 'Pinned official Memos image',
        },
        {
          label: 'Storage capacity',
          key: 'persistence.size',
          type: 'text',
          default: '5Gi',
          description: 'SQLite, local attachments and instance state',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Enables anonymous public notes and RSS; leave empty for a private instance',
        },
        {
          label: 'Administrator Secret',
          key: 'bootstrap.existingSecret',
          type: 'text',
          default: '',
          description: 'Initial password only; existing accounts remain intact',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'select',
          default: 'sqlite',
          description: 'Select the application database',
          options: ['sqlite', 'postgres', 'mysql'],
          valueActivationValues: {
            sqlite: { 'postgresql.enabled': 'false', 'mysql.enabled': 'false' },
            postgres: { 'mysql.enabled': 'false' },
            mysql: { 'postgresql.enabled': 'false' },
          },
        },
        {
          label: 'Install PostgreSQL',
          ...
          type: 'toggle',
          default: 'false',
          description: 'HelmForge PostgreSQL with generated application credentials',
          toggleActivationValues: { true: { 'database.driver': 'postgres', 'mysql.enabled': 'false' } },
        },
        {
          label: 'Install MySQL',
          key: 'mysql.enabled',
          type: 'toggle',
          default: 'false',
          description: 'HelmForge MySQL with generated application credentials',
          toggleActivationValues: { true: { 'database.driver': 'mysql', 'postgresql.enabled': 'false' } },
        },
        {
          label: 'External host',
          key: 'database.host',
          type: 'text',
          default: '',
          description: 'Disable both bundled databases to use an external server',
        },
        {
          label: 'External database',
          key: 'database.name',
        ...
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Secret containing the database password',
        },
        {
          label: 'Database CA Secret',
          key: 'database.caSecret',
          type: 'text',
          default: '',
          description: 'Private CA for verified external SQL TLS',
        },
      ],
    },
    {
      ...
      fields: [
        {
          label: 'Manage registration policy',
          key: 'provisioning.manageGeneralSettings',
          type: 'toggle',
          default: 'true',
          description: 'Closes registration; disable to preserve an existing database-managed policy',
        },
        {
          ...
          type: 'text',
          default: '',
          description: 'Native JSON files for OAuth, S3 and instance settings; overrides generated policy',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'toggle',
          default: 'true',
          description: 'Same-namespace HTTP; configure controller peers for Ingress',
        },
        {
          label: 'Isolate egress',
          key: 'networkPolicy.egressIsolation',
          type: 'toggle',
          default: 'true',
          description: 'DNS and selected bundled database only; explicitly allow integrations',
        },
      ],
    },
  ],
