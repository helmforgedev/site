...
export const chartCategories: ChartCategory[] = [
  ...
  },
  {
    ...
    charts: [
      ...
      { label: 'NoteDiscovery', href: '/docs/charts/notediscovery', maturity: 'stable' },
      { label: 'MediKeep', href: '/docs/charts/medikeep', maturity: 'stable' },
      { label: 'Poznote', href: '/docs/charts/poznote', maturity: 'stable' },
  ...
  },
  {
    ...
    charts: [
      ...
      { label: 'Nextcloud', href: '/docs/charts/nextcloud', maturity: 'stable' },
      ...
      { label: 'NetBox', href: '/docs/charts/netbox', maturity: 'stable' },
  ...
  },
  {
    label: 'Automation & AI',
    charts: [
      { label: 'OpenClaw', href: '/docs/charts/openclaw', maturity: 'stable' },
  ...
  },
  {
    ...
    charts: [
      ...
      { label: 'Matomo', href: '/docs/charts/matomo', maturity: 'stable' },
    ],
  },
  {
    ...
    charts: [
      ...
      { label: 'BookLore', href: '/docs/charts/booklore', maturity: 'stable' },
