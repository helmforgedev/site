...
`docker.io/library/memcached:1.6.45` image and supports a small development cache as well as a production path with
...
- **Official image alignment** - defaults to `docker.io/library/memcached:1.6.45`, the current stable upstream release.
...
| `image.tag`                                   | `1.6.45`                      | Pinned Memcached image tag.                                                   |
