...
<Callout type="danger" title="Vaultwarden 1.37.2 compatibility update">
  ...
  Bitwarden clients 2026.7.0 and newer. HelmForge pins 1.37.2 because it includes the follow-up fixes and is required
  for compatibility with Bitwarden clients 2026.8.0 and newer. Upgrade all older deployments.
</Callout>
...
| `image.tag`        | string | `"1.37.2"`                     | Image tag.                           |
