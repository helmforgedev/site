...
<Callout type="danger" title="Vaultwarden 1.37.1 security update">
  ...
  Bitwarden clients 2026.7.0 and newer. HelmForge pins 1.37.1 because it includes the follow-up invitation-flow and
  Alpine/OpenSSL fixes. Upgrade all older deployments.
</Callout>
...
| `image.tag`        | string | `"1.37.1"`                     | Image tag.                           |
