...
| `image.tag`        | string | `"v0.63.14"`                  | Image tag.                           |
...
database, keep the encryption key stable, and review the
[official Metabase 63 changelog](https://www.metabase.com/changelog/63#metabase-6314) before
