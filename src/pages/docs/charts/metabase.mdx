...
| `image.tag`        | string | `"v0.63.16"`                  | Image tag.                           |
...
Metabase v0.63.16 is a public maintenance release. Back up the Metabase
application database, keep the encryption key stable, and review the
[official Metabase 63 changelog](https://www.metabase.com/changelog/63#metabase-6316)
