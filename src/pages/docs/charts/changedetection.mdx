...
packages the official `ghcr.io/dgtlmoon/changedetection.io:0.60.3` image with persistent `/datastore` storage and an
...
| `image.tag`                                 | `0.60.3`                              | Pinned upstream image tag.                                              |
