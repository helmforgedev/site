...
| `image.tag`                                   | `9.5.2`                     | Elasticsearch version                                    |
...
| `kibana.image.tag`                            | `9.5.2`                     | Kibana version aligned with Elasticsearch                |
...
The chart pins Elasticsearch and Kibana to `9.5.2`. Review the
