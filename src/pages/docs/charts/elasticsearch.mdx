...
| `image.tag`                                   | `9.5.1`                     | Elasticsearch version                                    |
...
| `kibana.image.tag`                            | `9.5.1`                     | Kibana version aligned with Elasticsearch                |
...
The chart pins Elasticsearch and Kibana to `9.5.1`. Review the
