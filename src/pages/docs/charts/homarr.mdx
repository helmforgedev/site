...
The chart defaults to Homarr `v1.76.0`. This release fixes startup ownership
handling for default IDs, TrueNAS capacity reporting, Home Assistant widget
responsiveness, and several monitoring widgets.
Review the
...
| `image.tag`        | string | `"v1.76.0"`                  | Image tag.         |
