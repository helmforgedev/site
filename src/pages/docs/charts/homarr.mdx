...
The chart defaults to Homarr `v1.75.0`. This release fixes startup when IPv6 is
disabled in the container and includes integration and UI maintenance fixes.
Review the
...
| `image.tag`        | string | `"v1.75.0"`                  | Image tag.         |
