...
The chart defaults to Homarr `v1.70.0`. This release adds integrations and fixes widget secrets, forms, query caching, and layout stacking so the AppShell header renders above
...
| `image.tag`        | string | `"v1.70.0"`                  | Image tag.         |
