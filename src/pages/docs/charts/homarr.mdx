...
The chart defaults to Homarr `v1.71.0`. This release restores database migration journal entries, improves integrations and
widgets, and fixes container image builds. Review the upstream Homarr release notes before upgrading production environments.
...
| `image.tag`        | string | `"v1.71.0"`                  | Image tag.         |
