...
The chart defaults to stable Homarr `v1.77.0`. This update includes translations,
documentation, and an announcement of the separate v2 beta. It keeps the v1
deployment contract, with no new required environment variables. Review the
...
| `image.tag`        | string | `"v1.77.0"`                  | Image tag.         |
