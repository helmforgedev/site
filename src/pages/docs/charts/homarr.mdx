...
The chart defaults to Homarr `v1.72.0`. This release adds album-free random photos for Immich, humidity and animated weather
in clock widgets, and fixes permission visibility, media integrations, response caching, and Beszel subscription memory
growth. No breaking changes or new required environment variables were identified. Review the upstream Homarr release notes
...
| `image.tag`        | string | `"v1.72.0"`                  | Image tag.         |
