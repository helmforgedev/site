...
The chart defaults to stable Homarr `v1.77.1`. This patch fixes the board access-control
form and removes the v2 beta announcement. It keeps the v1 deployment
contract, with no new required environment variables. Review the
...
| `image.tag`        | string | `"v1.77.1"`                  | Image tag.         |
