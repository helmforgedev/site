...
This chart pins Jenkins `2.568.2-lts-jdk21`. Back up `JENKINS_HOME` before plugin, Java, or Jenkins LTS upgrades. Treat plugin upgrades as application changes:
...
| `image.tag`                        | `2.568.2-lts-jdk21`         | Pinned Jenkins LTS controller image tag.                                         |
