...
`docker.io/library/wordpress:7.0.2-apache` image. The chart keeps the default install useful for
...
WordPress 7.0.2 is an [urgent security release](https://wordpress.org/news/2026/07/wordpress-7-0-2-release/)
that fixes one critical and one high-severity vulnerability. Upgrade affected installations immediately.
...
| `image.tag`        | string  | `7.0.2-apache`                | Image tag.                               |
