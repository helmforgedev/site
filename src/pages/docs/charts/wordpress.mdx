...
`docker.io/library/wordpress:7.0.4-apache` image. The chart keeps the default install useful for
...
The chart pins WordPress `7.0.4`. Review the
...
| `image.tag`        | string  | `7.0.4-apache`                | Image tag.                               |
