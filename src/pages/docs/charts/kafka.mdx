...
- [Chart source](https://github.com/helmforgedev/charts/tree/main/charts/kafka)
- [Chart design](https://github.com/helmforgedev/charts/blob/main/charts/kafka/DESIGN.md)
- [Standards completion PR](https://github.com/helmforgedev/charts/pull/511)
...
<Callout type="info" title="Metrics agent verification">
