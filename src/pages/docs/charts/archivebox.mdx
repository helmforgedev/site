...
Production hardening should include explicit CPU and memory limits, restricted
namespace network policy where required, and existing Secrets for admin and S3
credentials.
