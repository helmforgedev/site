...
Run only the command for the source engine. The protected client settings must
point to the isolated restore server; create `moodle_restore` before importing.
