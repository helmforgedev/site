...
pinned `tool_monitoring` plugin. See [Authenticated application metrics](#authenticated-application-metrics)
...
| `metrics.enabledMetrics`                   | `["courses","overdue_tasks","quiz_attempts_in_progress","user_accounts","users_online"]`                         | Built-in metrics managed by Helm; custom plugin metrics remain administrator-managed.         |
