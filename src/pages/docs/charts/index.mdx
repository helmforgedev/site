...
| [Valkey](/docs/charts/valkey)         | Valkey with standalone, replication, Sentinel, and cluster topologies |
...
| [Memcached](/docs/charts/memcached) | Distributed memory cache with TLS, extstore, metrics, and dual-stack Services     |
...
| [ZooKeeper](/docs/charts/zookeeper) | Replicated coordination ensembles with quorum validation and metrics              |
...
| [OAuth2 Proxy](/docs/charts/oauth2-proxy) | OAuth2/OIDC reverse proxy with hardened proxy trust         |
| [SonarQube](/docs/charts/sonarqube)       | Code quality platform with plugin automation and PostgreSQL |
...
| [Envoy Gateway CRDs](/docs/charts/envoy-gateway-crds) | Standalone lifecycle for Envoy Gateway and Gateway API CRDs          |
...
| [Apache](/docs/charts/apache)                   | Apache HTTP Server with custom content, metrics, and Gateway API                 |
| [Tomcat](/docs/charts/tomcat)                   | Apache Tomcat with official image, health webapp, JMX, and production controls   |
| [Immich](/docs/charts/immich)                   | Photo and video management with PostgreSQL, Redis-compatible cache, and ML       |
| [Ente](/docs/charts/ente)                       | End-to-end encrypted photos with PostgreSQL, external S3, safe HA, and backup    |
| [OpenCut](/docs/charts/opencut)                 | Open-source video editor with PostgreSQL and Redis dependencies                  |
| [OpenReel Video](/docs/charts/openreel-video)   | Browser-based video editor with WebCodecs-ready static hosting                   |
| [MediKeep](/docs/charts/medikeep)               | Personal medical records with PostgreSQL, uploads, backups, and privacy controls |
| [Poznote](/docs/charts/poznote)                 | Self-hosted note-taking with SQLite, OIDC authentication, and Markdown support   |
...
| [Metrics Server](/docs/charts/metrics-server)      | Kubernetes Metrics API server for autoscaling pipelines          |
...
| [Kibana](/docs/charts/kibana)               | Elastic Stack visualization UI with secure Elasticsearch connectivity              |
...
| [JupyterHub](/docs/charts/jupyterhub)         | Multi-user notebook platform with KubeSpawner and configurable-http-proxy                 |
...
| [Matterbridge](/docs/charts/matterbridge) | Matter plugin manager with persistent fabric identity and practical LAN-aware networking       |
...
| [Jenkins](/docs/charts/jenkins)       | Automation server with JCasC, plugin bootstrap, and Kubernetes agents  |
