...
New installations use the [Envoy Gateway CRDs chart](/docs/charts/envoy-gateway-crds)
...
See the [standalone CRD lifecycle documentation](/docs/charts/envoy-gateway-crds)
