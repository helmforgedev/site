...
The HelmForge NoteDiscovery chart uses the official `ghcr.io/gamosoft/notediscovery:0.28.3` image and deploys a single-writer web application.
...
This chart still writes the data directory into `config.yaml`
