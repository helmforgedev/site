...
The HelmForge NoteDiscovery chart uses the official `ghcr.io/gamosoft/notediscovery:0.31.3` image and deploys a single-writer web application.
...
URL configuration. Review the
[upstream v0.31.3 release](https://github.com/gamosoft/NoteDiscovery/releases/tag/v0.31.3)
before upgrading.
