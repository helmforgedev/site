...
The HelmForge NoteDiscovery chart uses the official `ghcr.io/gamosoft/notediscovery:0.31.1` image and deploys a single-writer web application.
...
retaining interactive task checkboxes and cache-safe asset behavior. Review the
[upstream v0.31.1 release](https://github.com/gamosoft/NoteDiscovery/releases/tag/v0.31.1)
before upgrading.
