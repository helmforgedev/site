...
This chart tracks Drupal `11.4.0`, an upstream Drupal 11 release.
The bundled HelmForge MySQL dependency is aligned to the current
`2.0.2` chart while preserving the same Drupal installer values for the default
