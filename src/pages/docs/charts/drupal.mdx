...
- `docker.io/library/drupal:11.4.6-php8.5-apache-bookworm`
...
database mode used in production. Review the Drupal 11.4.6 release notes before
...
| `image.tag`             | `11.4.6-php8.5-apache-bookworm`  | Pinned Drupal image tag                         |
