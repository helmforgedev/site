...
- `docker.io/library/drupal:11.4.5-php8.5-apache-bookworm`
...
This chart tracks Drupal `11.4.5`, a patch release with upstream bug fixes.
Review the upstream release notes for the complete list of resolved issues and
any known regressions.

The bundled HelmForge MySQL dependency is aligned to the current `2.0.3` chart
...
database mode used in production. Review the Drupal 11.4.5 release notes before
...
| `image.tag`             | `11.4.5-php8.5-apache-bookworm`  | Pinned Drupal image tag                         |
