...
- `docker.io/library/drupal:11.4.4-php8.5-apache-bookworm`
...
This chart tracks Drupal `11.4.4`, a security release that fixes moderately
critical information-disclosure and cross-site scripting vulnerabilities.
Drupal recommends updating 11.4.x sites immediately; no unrelated fixes are
...
database mode used in production. Review the Drupal 11.4.4 release notes and
security advisories before running database updates.
...
| `image.tag`             | `11.4.4-php8.5-apache-bookworm`  | Pinned Drupal image tag                         |
