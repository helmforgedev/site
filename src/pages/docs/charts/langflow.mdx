...
The HelmForge Langflow chart uses the official `docker.io/langflowai/langflow:1.11.3` image and exposes the web/API server on port `7860`.
...
1.11 patch releases. Configure optional runtime capabilities through `app.env` or `app.envFrom`.
