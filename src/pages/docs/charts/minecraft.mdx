...
- **Pinned upstream image** — defaults to `2026.8.0`, with Java-specific tags available when needed
...
| ----------------- | ------------- | ------------------- |
| 1.21.5+           | Java 25       | `2026.8.0`          |
| 1.20.x - 1.21.4   | Java 21       | `2026.8.0-java21`   |
| 1.17.x - 1.19.x   | Java 17       | `2026.8.0-java17`   |

The chart defaults to the dated upstream image tag `2026.8.0`. Pin `image.tag`
to a Java-specific variant, such as `2026.8.0-java21`, when running older
...
| `image.tag`        | string | `"2026.8.0"`                      | Image tag. Use Java-specific variants for older Minecraft versions. |
...
| `backup.images.worker`                 | string  | `docker.io/itzg/minecraft-server:2026.8.0` | Image for RCON and tar operations.                           |
...
`docker.io/itzg/minecraft-server:2026.8.0` adds GTNH daily builds and Java 25 fixes while retaining native IPv6 preference and a
