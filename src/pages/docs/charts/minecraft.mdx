...
- **Pinned upstream image** — defaults to `2026.8.2`, with Java-specific tags available when needed
...
| ----------------- | ------------- | ------------------- |
| 1.21.5+           | Java 25       | `2026.8.2`          |
| 1.20.x - 1.21.4   | Java 21       | `2026.8.2-java21`   |
| 1.17.x - 1.19.x   | Java 17       | `2026.8.2-java17`   |

The chart defaults to the dated upstream image tag `2026.8.2`. Pin `image.tag`
to a Java-specific variant, such as `2026.8.2-java21`, when running older
...
| `image.tag`        | string | `"2026.8.2"`                      | Image tag. Use Java-specific variants for older Minecraft versions. |
...
| `backup.images.worker`                 | string  | `docker.io/itzg/minecraft-server:2026.8.2` | Image for RCON and tar operations.                           |
...
`docker.io/itzg/minecraft-server:2026.8.2` fixes Modrinth packs that require server-side mods and corrects
