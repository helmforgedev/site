...
- **Pinned upstream image** — official MongoDB `8.3.8` patch release
...
| `image.tag`        | string | `"8.3.8"`                 | Image tag.     |
...
MongoDB `8.3.8` is a patch within the `8.3` release line. Review the
