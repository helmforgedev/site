...
<Callout type="danger" title="Valkey 9.1.2 security update">
  Valkey classifies 9.1.2 as a security release. It fixes use-after-free vulnerabilities in the Lua debugger and
  optional RDMA transport, plus ACL, RDB validation and AOF replay defects. Upgrade deployments on the 9.1 release line
  and verify persistence and HA behavior in your environment.
</Callout>

## Key Features

- Official `docker.io/valkey/valkey` image pinned to `9.1.2`
...
| `image.tag`                                 | `9.1.2`                   | Pinned Valkey image tag.                                         |
...
| `tests.image.tag`                           | `9.1.2`                   | Pinned image tag for the Helm connection test.                   |
