...
- Official `docker.io/clickhouse/clickhouse-server` image pinned to `26.7.3`
...
This chart now uses ClickHouse 26.7 stable. Before upgrading a production
...
| `image.tag`                            | `26.7.3`                                 | Official full-version image tag.                           |
