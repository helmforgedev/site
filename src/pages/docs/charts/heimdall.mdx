...
The chart uses Heimdall `2.8.3` and rejects empty image repository or tag values
...
- [Chart standards PR](https://github.com/helmforgedev/charts/pull/508)
...
| `image.tag`        | string | `"2.8.3"`                        | Image tag.                           |
