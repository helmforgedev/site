...
**Image:** `docker.io/helmforge/strapi-base:5.50.2`

### Key Features

- **Strapi 5.50.2** — Stable HelmForge base image with security patches
...
```dockerfile
# Dockerfile
FROM docker.io/helmforge/strapi-base:5.50.2
...
| `image.tag`                | `5.50.2`                | HelmForge Strapi base image tag                       |
