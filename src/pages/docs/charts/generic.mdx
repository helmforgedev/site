...
<Callout type="warning" title="Breaking feature release">
  The default image is now pinned to `docker.io/library/nginx:1.31.3`, image pull policy defaults to `IfNotPresent`, pod
...
<Callout type="info" title="NGINX 1.31.3 security update">
  The default image includes fixes for CVE-2026-42533, CVE-2026-60005, and CVE-2026-56434. No Generic chart
  configuration changes are required for this image update.
</Callout>
...
| `image.tag`            | `1.31.3`                  | Default image tag.                                            |
