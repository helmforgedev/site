...
| `image.tag`        | string | `"2026.8.2"`                       | Image tag.                           |
...
## Upgrading to 2026.8.2

Cloudflared 2026.8.2 fixes the path normalization and trailing-slash regressions
introduced in the earlier 2026.8 releases. The Kubernetes tunnel command,
metrics endpoints, probes, and chart values contract are unchanged.
