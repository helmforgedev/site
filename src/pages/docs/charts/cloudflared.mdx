...
The deprecated `transport-loglevel` flag is restored after its removal in 2026.9.0. The chart's tunnel command, metrics
endpoints, probes, and values contract are unchanged.
