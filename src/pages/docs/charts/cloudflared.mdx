...
## Upgrading to 2026.8.3

Cloudflared 2026.8.3 updates its WebSocket dependency and distroless base image,
and removes obsolete test reconnect and remote protocol-selection code.
Automatic reconnection remains supported. The chart's tunnel command, metrics
