...
- Official `quay.io/oauth2-proxy/oauth2-proxy` image pinned to `v7.15.4`
...
Version v7.15.4 updates the runtime to Go 1.26.7 and addresses the dependency vulnerabilities listed in the official
release notes. No chart values migration is required from v7.15.3.
