...
- **Gateway API** — optional HTTPRoutes for admin and phishing listeners with separate parentRefs
- **Dual-stack Services** — optional IP family policy and families for admin and phishing Services
...
Use Gateway API when an existing Gateway controller owns ingress and the chart should create HTTPRoutes instead of classic Ingress objects. Admin and phishing routes are configured independently so the admin UI can stay on an internal listener while the phishing listener uses a public Gateway.
...
| `service.ipFamilyPolicy`                      | string  | omitted                               | Shared Service IP family policy fallback      |
| `service.ipFamilies`                          | array   | `[]`                                  | Shared ordered Service IP families fallback   |
...
| `gatewayAPI.enabled`                          | boolean | `false`                               | Enable Gateway API HTTPRoutes                 |
| `gatewayAPI.admin.enabled`                    | boolean | `false`                               | Render admin HTTPRoute                        |
| `gatewayAPI.admin.parentRefs`                 | array   | `[]`                                  | ParentRefs for admin Gateway listeners        |
| `gatewayAPI.phish.enabled`                    | boolean | `false`                               | Render phishing HTTPRoute                     |
| `gatewayAPI.phish.parentRefs`                 | array   | `[]`                                  | ParentRefs for phishing Gateway listeners     |
