...
| `gateway.enabled`                             | boolean | `false`                               | Enable Gateway API HTTPRoutes                 |
| `gateway.admin.enabled`                       | boolean | `false`                               | Render admin HTTPRoute                        |
| `gateway.admin.parentRefs`                    | array   | `[]`                                  | ParentRefs for admin Gateway listeners        |
| `gateway.phish.enabled`                       | boolean | `false`                               | Render phishing HTTPRoute                     |
| `gateway.phish.parentRefs`                    | array   | `[]`                                  | ParentRefs for phishing Gateway listeners     |
