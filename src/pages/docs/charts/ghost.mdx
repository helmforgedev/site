...
<Callout type="info" title="Ghost 6.59.0 update">
  Ghost 6.59.0 adds Docker Secrets configuration support and fixes MySQL migrations on older MySQL 8 releases,
  outbound-request crashes, member imports, newsletter filters, and donation checkout. Back up content and the database
...
| `image.tag`        | string | `"6.59.0"`                | Image tag.                           |
