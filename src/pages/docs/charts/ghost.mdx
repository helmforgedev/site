...
<Callout type="info" title="Ghost 6.63.0 update">
  Ghost 6.63.0 adds Node 24 support, updates the Source theme, and fixes member preferences, plan-change reporting and
  tag search without changing the official container contract. Back up content and the database, then validate themes,
  integrations, newsletters, comments, and member signup paths before upgrading production sites.
</Callout>
...
| `image.tag`        | string | `"6.63.0"`                | Image tag.                           |
