...
<Callout type="info" title="Ghost 6.61.0 update">
  Ghost 6.61.0 includes application features and maintenance fixes without changing the official container contract.
  Back up content and the database, then validate themes, integrations, newsletters, comments, and member signup paths
...
| `image.tag`        | string | `"6.61.0"`                | Image tag.                           |
