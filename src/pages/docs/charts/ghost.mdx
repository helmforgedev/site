...
<Callout type="info" title="Ghost 6.53.0">
  This release strengthens spam-signup protection, adds adapter boot-time validation, improves author selection and
  analytics performance, and fixes expired-session and editor-state issues. No chart configuration changes are required.
</Callout>
...
| `image.tag`        | string | `"6.53.0"`                | Image tag.                           |
