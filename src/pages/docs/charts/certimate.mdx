...
The HelmForge Certimate chart uses the official `certimate/certimate:v0.4.32` image. Certimate listens on port `8090` and stores PocketBase state under `/app/pb_data`.
...
configuration contract. Review the
[upstream v0.4.32 release](https://github.com/certimate-go/certimate/releases/tag/v0.4.32)
before upgrading.
