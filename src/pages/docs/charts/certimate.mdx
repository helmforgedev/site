...
Keep `persistence.mountPath` stable across upgrades. Certimate runs PocketBase migrations on startup, so take a PVC snapshot before upgrading production installs.
