...
The HelmForge Certimate chart uses the official `certimate/certimate:v0.4.27` image. Certimate listens on port `8090` and stores PocketBase state under `/app/pb_data`.
