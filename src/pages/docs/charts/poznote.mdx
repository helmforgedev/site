...
The HelmForge Poznote chart uses the official `ghcr.io/timothepoznanski/poznote:6.35.0` image. The container serves the web frontend and API on port `80`, stores all data (notes, attachments, configuration) in a SQLite database under `/var/www/html/data`.
