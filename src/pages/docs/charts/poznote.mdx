...
The HelmForge Poznote chart uses the official `ghcr.io/timothepoznanski/poznote:6.86.0` image. The container serves the web frontend and API on port `80`, stores SQLite, notes, attachments and configuration under `/var/www/html/data`.
